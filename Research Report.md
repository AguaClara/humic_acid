...
<div class="alert alert-block alert-danger">
Revise for grammar and spacing around parantheses.

Revise "Therefore, the Spring 2018 Humic Acid subteam will test...between coagulant dose and effluent turbidity with humic acid existing."
</div>
...
<div class="alert alert-block alert-danger">
put space before the start of parantheses
</div>
...
Also did you talk about your flocculator or how everything connects together? - unresolved
</div>
...
<div class="alert alert-block alert-danger">
Please convert any important MathCAD files into python and include them in your manual.- unresolved?

Are you using ProCoDA to turn your pumps on and off? - unresolved

Is the turbidity supposed to be around 3 NTU at the end of the experiment (like when it is nearly over) or do you mean after the sed tank (near the end of the apparatus)? - unresolved

Please revise for consistency/spelling/grammar
</div>
...
<div class="alert alert-block alert-danger">
you can just put the units once at the ends
</div>
...
<div class="alert alert-block alert-danger">
This needs revision for clarity and understanding. Connect why the head loss is important.
</div>
...
<div class="alert alert-block alert-danger">
flocculator is the correct spelling
</div>
...
is it the clay or the coagulant sticking to the flocculator? how do you know this?
</div>
...
you dont explain the last sentence in your analysis section. Nothing should be new in the conclusion
</div>
...
Move most of this into conclusions. This section should be mostly about next steps in the lab and only a minor mention of real-world implications.

You continuously mention a mathematical model, but where is the progress on this task?

Watch out for run-on sentences. Revise this section very carefully.
</div>
...
<div class="alert alert-block alert-danger">
consider referencing important past AguaClara research reports here - unresolved
</div>
...
Have verbs in each step i.e."Check that the stock solutions are adequately filled"
