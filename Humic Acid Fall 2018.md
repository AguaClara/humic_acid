...
[Clare: Hello Humic Acid! I'll write my comments in the square brackets like this. Please feel free to delete these when you revise or update your report. ]
...
[**Be sure to change the tense of this in the final report as these will be thing you have done rather than things you will do**]


## Literature Review
NOM negatively affects water quality in a number of ways. It causes discoloration, taste and odor problems, and biological growth in distribution systems. It also increases the concentration of heavy metals and absorbed organic pollutants. The increased particles in water consequently cause an increase in sludge volumes. Matilainen et al. suggests that optimized coagulation is the major treatment option in decreasing NOM level (2010). [**Be sure to include all sources in the bibliography/link to them directly with a hyperlink**] However, the nature of NOM has significant effects on the removal efficiency of coagulation. Additionally, the hydrophobic portion of NOM is generally removed more effectively with coagulation than the hydrophilic portion is. The removal efficiency of NOM also depends on several factors such as pH, temperature and coagulant type.

Regarding NOM removal efficiency, Soh et al. isolated dissolved NOM into four organic fractions based on their hydrophobic and hydrophilic properties (very hydrophobic acids, slightly hydrophobic acids, charged hydrophilics, and neutral hydrophilics) (2008)[**same as above, hyperlink/include full reference in bibliography**]. His experiment was designed to determine the impact of alum coagulation on removal of these fractions in conventional water treatment. He found that the alum removed mostly hydrophobic and higher molecular weight components of NOM. This result further verified that the NOM removal efficiency is correlated with the properties of NOM. His study also revealed that, even though alum coagulation removed a large proportion of NOM, a significant amount of the NOM resisted coagulation as well. This implies that NOM removal will not improve significantly at very high coagulant dosage.
...
[**change previous paragraph to past tense**]
...
[**this picture is bit small, consider increasing the size slightly**]

To standardize with setup of other dissolved species sub-teams, the team also used PVC pipe to mimic the sedimentation tank. 1-inch clear PVC pipe was chosen and fabricated so that the experimental apparatus had a 50 cm recirculator (14) and 35 cm tube settler(15). The floc wire [**weir?**] was 40 cm and the bent angle of tube settler was angled 60 degrees relative the horizontal. The length of the tube settler was determined so that a capture velocity of .308 mm/s would be achieved at the end of the reactor [**I think this should be "within the reactor" not at the end of the reactor because of how capture velocity is defined**]. The design was obtained from High Rate Sedimentation sub-team.  [**If you can find it, a link to the manual that defined the parameters for this design would be useful so later teams can more easily reconstruct it if necessary**]

###### Other Apparatus
<img src="https://github.com/AguaClara/humic_acid/blob/master/apparatus2018.png?raw=true" height=250 width=400>

Figure 2: Other apparatus consisting of pumps, turbidimeters, flocculator and a spectrophotometer. [**The labels in this image are impossible to read. If the set-up is useful to show, consider making a labelled schematic or putting larger labels on this image, that would also help for the number in the following description**]
...
[**This is a very clear description of your set-up!**]
...
Figure 4: The results for preliminary test #1 [**Add a brief sentence of why this graph is important, so someone skimming could easily see the importance of this test**]
...
Figure 5: The results from preliminary test #2 [**Add a brief sentence of why this graph is important, so someone skimming could easily see the importance of this test**]
...
Figure 6: The results from preliminary test #3 [**Add a brief sentence of why this graph is important, so someone skimming could easily see the importance of this test**]
...
[**Great description of how these tests fit together to yield meaningful information!**]
...
### Experimental Methods
### Set-up
* Choose the experimental set-up to standardize with other particle-removal subteams. Construct the recirculator and flocculator. The recirculator was constructed from clear PVC piping. The floc weir was attached to the recirculator with adhesive. The flocculator is made from plastic tubing, which is coiled around a cardboard cylinder. [**link to fabrication manual for flocculator and recirculator**]
* Set up ProCoDA by determining what pumps and turbidimeters needed to be controlled based on experimentation purposes. For our [**avoid personal pronouns**] experiment, we  [**avoid personal pronouns**] pump humic acid, water, and coagulant at constant rates, so they don't need to be controlled directly by ProCoDA. We  [**avoid personal pronouns**] just turn on or off these pumps manually by pressing the block switch on the pump. The turbidimeters and pressure sensor are also linked to ProCoDA to collect output data. On the other hand, the clay pump does need to be controlled by ProCoDA because the influent turbidity should keep at 100NTU. The clay pump is on while the ProCoDA program is operating.
...
[**Fix the typo before "ProCoDA", adapt punctuation**]
